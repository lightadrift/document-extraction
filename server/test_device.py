...
try:
    if platform.system() == "Linux":
        ...
        print("Skipping ROCM support check on non-Linux systems.")
    ...
    # Skipping user group checks on Windows
    print("Skipping user group checks on Windows.")

    if torch.cuda.is_available():
        print("GOOD: PyTorch CUDA support found.")
        ...
        print("BAD: PyTorch CUDA support NOT found.")
